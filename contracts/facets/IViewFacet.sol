...
interface IViewFacet {
    ...
    function getMuonConfig() external view returns (uint256, uint256, uint256);

    function getMuonIds() external view returns (uint256, PublicKey memory, address);

    function pauseState() external view returns (bool, bool, bool, bool, bool, bool);
